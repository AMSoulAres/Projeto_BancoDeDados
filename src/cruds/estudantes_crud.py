...
async def insere_estudante(estudante: EstudantePost):
    dao.add_aluno(estudante.email, estudante.senha, estudante.curso, estudante.admin, estudante.image)
    return JSONResponse(status_code=201, content="Usuário criado com sucesso")
